"""Re-run the paired re-entry matrix against PR #6157 head 89a5f72e.
...
modified). What changed is the set of pybind11 trees:
    ...
    new   89a5f72e   bump reverted + destructor recovery   (under review)

The question rwgk asked for a review on: does 89a5f72e turn the pointer-only
...
TREES = {
    ...
    "new": SCRATCH / "trees" / "pybind-pybind11-89a5f72e",
}
...
ARMS = [
    ...
    ("mixed_new", "prod_new", "cons_v12", "under review: 89a5f72e producer + v12 consumer"),
    ("pure_old", "prod_old", "cons_old", "control: 4455e3f on both sides"),
    ("pure_new", "prod_new", "cons_new", "control: 89a5f72e on both sides"),
    ("reverse_new", "prod_v12", "cons_new", "reverse direction: v12 producer + 89a5f72e consumer"),
]
